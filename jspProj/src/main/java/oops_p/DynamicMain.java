...
public class DynamicMain {
	...
	public static void main(String[] args) {
		...
		Par dpp = new Par();
		Par dpc = new Child1();
		//Child1 dcp = new Par();  자식이 더 큰 개념이라 부모가 자식을 담을 수 없음
		...
		//System.out.println("dpcc : "+dpcc.a+","+dpcc.b+","+dpcc.c);  부모로 바뀌었기때문에 c를 불러올 수 없음
		dpcc.meth_1();
		dpcc.meth_2();
		//dpcc.meth_3();
		...
		//System.out.println(cc1 instanceof Uncle);  상속관계에서만 instanceof 가능
